...
class RenderUtils(object):
    ...
    def build_base_info(self):
        ...
        self.ray_xy = xy.unsqueeze(0).to(self.device) # [1,2,1024]
        self.ray_uv = uv.unsqueeze(0).to(self.device) # [1,1024,2]
    ...
    def build_cam_info(self):
        ...
        for angle in angles:
            ...
            cam_info = {
                "batch_Rmats": rmat, # [1,3,3]
                "batch_Tvecs": tvec, # [1,3,1]
                "batch_inv_inmats": self.inv_inmat, # [1,3,3]
            }
    ...
    def render_novel_views(self, net, code_info):
        ...
        batch_xy = self.ray_xy # [1,2,1024]
        batch_uv = self.ray_uv # [1,1024,2]
